...
// 1. Listen for the moment the user places a finger on the screen
...
// 2. Listen for the moment the user lifts their finger off the screen
...
function handleSwipeGesture(startX, startY, endX, endY) {
  ...
  const minSwipeDistance = 60; // 🌟 CRITICAL: Minimum pixels required to count as a deliberate swipe
